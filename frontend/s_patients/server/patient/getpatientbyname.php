<?php
/**
 * Retrieve PID, Name, DateOfBirth and Status from the database
 * for a specific patient using the patient name.
 * 
 * Runs queries on the Patient-table and echoes the results
...
/** Query to run on the database. {@param q} is the patient-name which will be searched. */
